...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  void initState() {
    super.initState();
    _phasePageController = PageController();
  ...
  Widget build(BuildContext context) {
    ...
    final currentIndex = setup.milestones
        .indexOf(currentMilestone)
        .clamp(0, setup.milestones.length - 1);
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      final page = (_phasePageController.page ?? 0).round();
      if (page != currentIndex) {
        _phasePageController.jumpToPage(currentIndex);
      }
    });
      ...
      child: Focus(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            toolbarHeight: 64,
            titleSpacing: 20,
            backgroundColor: appBarDimmed
                ? Colors.transparent
                : Theme.of(context).appBarTheme.backgroundColor,
            title: IgnorePointer(
              ignoring: appBarDimmed,
                      ...
                      Expanded(
                        child: LiquidGlassCard(
                          ...
                          child: PageView.builder(
                            ...
                            onPageChanged: (index) {
                              ref
                                      .read(selectedMilestoneProvider.notifier)
                                      .state =
                            ...
                            itemBuilder: (_, index) {
                              ...
                              final scripts = ref.watch(
                                formattedRoutineScriptsByMilestoneProvider(
                                  milestone,
                                ),
                              );
                              final phaseAudio =
                                  ref
                                      .watch(
                                        phaseAudioForMilestoneProvider(
                                          milestone,
                                        ),
                                      )
                                      .valueOrNull ??
          ...
          bottomNavigationBar: QuickDock(
            highlightCategory: _suggestedCategoryForMilestone(currentMilestone),
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        Text('HL NO', style: labelStyle),
        const SizedBox(width: 6),
        Text(hlNoText, style: hlValueStyle),
      ],
    );
  }
}
